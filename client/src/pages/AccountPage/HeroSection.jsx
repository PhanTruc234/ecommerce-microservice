        ...
        <section className='container mt-32 flex items-center gap-12 font-heading'>
            <div className='space-y-10'>
                <div className='space-y-6 pr-15'>
                    <p className='uppercase text-xs font-semibold border rounded-full py-2 px-4 inline-block border-primary tracking-[2px]'>bộ sưu tập mới 2026</p>
                    <h1 className='title-hero'>Phong cách tối giản, hiệu quả tối đa.</h1>
