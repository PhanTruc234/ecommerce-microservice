...
packages:
  ...
  avvio@6.2.2:
    resolution: {integrity: sha512-7+yznbJOMoHQ8Z8VH+1meyRjtxUW8za6gqnHBl8DqlX5qPtaclNIgWrKrTLuIbfn2+1/EGkcr+rQXI8DYVU4RA==}
  ...
  bloomrun@4.1.1:
    resolution: {integrity: sha512-Hh4X2cD37yANldNrD/uaExTawDewgSkPvSoyG+ZOmvekbGmc12W2V6u5SRfdUCXjEMM1RBvJk0YHovaVw9xPCg==}
  ...
  errio@1.2.2:
    resolution: {integrity: sha512-Le3X3pR2h4qtAJXFyOEfMf9xsfy6v3Lb7Xbpf1/Wyux0lZfV6+vNoWWiqNjdCFrzrj+esQ2HwdK1/KkdgzrbKg==}
  ...
  hemera@0.0.5:
    resolution: {integrity: sha512-ndFkQuxqJPTJD6nZBHqsLGQhKRAOB66nmhkhugmDOjyroRNZbMdb10bdQWkMG3BBnv3UqeWNTbZ96/HW8y+ljw==}
  ...
  joi@11.1.1:
    resolution: {integrity: sha512-hffQzH42mYLvUCqhUPZZGegiiIjVvHcOV8mrxXPci8qZFOp2sHK4778GPyI3ZlvqTOHs8qZN6DovDnBR1slO4g==}
    engines: {node: '>=4.0.0'}
    deprecated: This version has been deprecated in accordance with the hapi support policy (hapi.im/support). Please upgrade to the latest version to get the best features, bug fixes, and security patches. If you are unable to upgrade at this time, paid support is available for older versions (hapi.im/commercial).
  ...
  nats-hemera@7.0.2:
    resolution: {integrity: sha512-Oi703cTrq5f0Iot9fOUy0oLN4AwH0jciC5I/j7pL8crmF0taUiBX7ujM1/Rq5DeqsAJIdL07erbH/cZnac81TA==}
    engines: {node: '>=6'}
    peerDependencies:
      nats: '>= 0.8.x <= 1.2.x'
  ...
  pino@5.13.6:
    resolution: {integrity: sha512-cYhvK4lopLnW/OtU3uRqBNsPiBt0Cdv97LGJg4yPGbGajlOjWWaODwD66q3Ynqnj6bSNw8HSofYcEOKZqh4Gcg==}
    hasBin: true
  ...
  super-error@2.2.1:
    resolution: {integrity: sha512-lemvbETTidllz9HfR0dQvtL2qbYNF25vv8CRH66hP4fM0mg1hQ/KoLurVNkKZDCjD+qkia0pFxTyCM20toJ41Q==}

  tinysonic@1.3.0:
    resolution: {integrity: sha512-wAKKbTqVn32VxH8PoxNbZ1oCu9IDeyMuQbmdljPfw3D2qGKUe1+88XNhOUfp90pO61Wv66yWZFEpnkawTnSm6w==}
